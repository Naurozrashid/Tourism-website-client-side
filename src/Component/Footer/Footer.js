    ...
    return (
      ...
      <div className="row mx-5 py-5">
        <div className="col m-2">
          ...
          <p>
          Vacaday is the main point of reference for online travel related reservation. Besides guaranteeing your best facilites, we do so at an unbeatable price, with discounts of up to 70% of the official price.
          </p>
        </div>
        ...
        <div className="col m-2">
          ...
          <h6>
            <i className="fas fa-paper-plane"></i> infoVacaday@gmail.com
          </h6>
